...
_The input of a program can take many forms, including data prompted by user or read from a file. These inputs determine how a program behaves, including its 
...
not, and whether or not they're reachable from the starting point._